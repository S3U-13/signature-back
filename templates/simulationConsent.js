...
`;
  ...
  return `
    ...
    <body>
        <h1 class="text-xl font-semibold text-center">หนังสืออธิบายเเละยินยอมให้ทำการจำลองการฉายรังสีโดยใช้รังสีเอกซเรย์เเละสารทึบรังสี</h1>

        <section class="flex items-start justify-between gap-2">
          <div class="space-y-3.5 w-full mt-2">
            <p class="text-xl text-center pl-35 font-semibold">หน่วยงานรังสีรักษาโรงพยาบาลพระปกเกล้า</p>
